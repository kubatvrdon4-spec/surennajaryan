...
const services = [
  ...
  },
  {
    ...
    accent: "Jídelníček",
    description: "Stravovací plán podle vašeho cíle a denního režimu — pro redukci hmotnosti i nabírání.",
    to: "/jidelnicek",
  },
];
  ...
  return (
    <main className="sn-home">
      ...
      <section className="sn-services" id="sluzby" aria-labelledby="services-title">
        ...
        <article className="sn-service sn-service-meal">
          <div>
            <h3><ServiceTitle title={services[4].title} accent={services[4].accent} /></h3>
            <p>{services[4].description}</p>
          </div>
          <Link to={services[4].to} data-track="services-meal-plan">Chci jídelníček na míru</Link>
        </article>
      </section>
      ...
      <section className="sn-faq" id="faq" aria-labelledby="faq-title">
        <div className="sn-faq-intro">
          ...
          <h2 id="faq-title"><span>Časté</span><strong>otázky</strong></h2>
          <span>Stručné odpovědi před prvním tréninkem.</span>
        </div>

        <span className="sn-faq-word" aria-hidden="true">FAQ</span>
