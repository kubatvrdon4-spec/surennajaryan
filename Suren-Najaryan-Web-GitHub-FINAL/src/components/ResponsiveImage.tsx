export type ImageName = "hero" | "portrait" | "training" | "movement" | "conditioning" | "process" | "meal-hero" | "meal-prep" | "boxing";
...
const imageData: Record<ImageName, { width: number; height: number }> = {
  ...
  "meal-hero": { width: 1254, height: 1254 },
  "meal-prep": { width: 1440, height: 960 },
  boxing: { width: 1254, height: 1254 },
};
